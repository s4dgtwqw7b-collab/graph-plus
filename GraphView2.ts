...
import { layoutGraph2D, layoutGraph3D } from './graph/layout';
import { createRenderer, Renderer2D } from './graph/renderer';
...
class Graph2DController {
  ...
  async init(): Promise<void> {
    ...
    this.renderer = createRenderer({ canvas, glow: initialGlow });
